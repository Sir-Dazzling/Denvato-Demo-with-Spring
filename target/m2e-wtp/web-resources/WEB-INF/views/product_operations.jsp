    	...
    	<div class="container">
        	<div class="col-md-3">
          		<ul class="nav nav-pills nav-stacked">
    				<li class="active"><a href="${pageContext.servletContext.contextPath}/productOperations">Add Product</a></li>
    				<li><a href="${pageContext.servletContext.contextPath}/modifyProductDetails">Modify Product Details</a></li>
        	...
        	<div class="col-md-9">
        		...
        		<rfd:form role="form" action="${pageContext.request.contextPath}/docreate" method="POST" modelAttribute="product">
