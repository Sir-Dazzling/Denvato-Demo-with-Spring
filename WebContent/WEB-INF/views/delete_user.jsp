    	...
    	<div class="container">
        	<div class="col-md-3">
          		<ul class="nav nav-pills nav-stacked">
    				<li ><a href="${pageContext.servletContext.contextPath}/userOperations">Add User</a></li>
    				<li><a href="${pageContext.servletContext.contextPath}/modifyUserDetails">Modify User Details</a></li>
    				<li class="active"><a href="${pageContext.servletContext.contextPath}/deleteUserAccount">Delete Existing User Account</a></li>
  		 		</ul>
        	</div>
        	<div class="col-md-9">
        		...
        		<rfd:form role="form"  action="${pageContext.request.contextPath}/deleteUser" method="POST" class="login-form" modelAttribute="user">    
			                       <div class="form-group">
			                        ...
			                        <button type="submit" value="submit" name="submit" class="btn" >Delete Account</button>
			                </rfd:form>
        	</div>
    	</div>
	</section>
